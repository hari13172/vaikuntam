...
function Header() {
  return (
    <header className="bg-white shadow-md max-w-7xl m-auto outline-none p-4 rounded-full">
      <div className="flex justify-between items-center  text-center">
        ...
        <div className="flex items-center border-2 border-gray-500 px-8 py-4 rounded-full">
